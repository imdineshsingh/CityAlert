...
import com.ghughutibasuti.cityalert.HomeActivity;
import com.ghughutibasuti.cityalert.R;
    ...
    public void onCreate(Bundle icicle) {
        ...
        btnPanic.setOnClickListener(new View.OnClickListener() {
            ...
            {/*
                ...
                String a=cont1.getText().toString();
                String b=cont2.getText().toString();
                String c=cont3.getText().toString();
                String d=cont4.getText().toString();
